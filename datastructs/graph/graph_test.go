...
var testCases = []testCase{
	{7, [][]int{[]int{0, 1}, []int{2, 4}, []int{1, 5}, []int{7, 5}, []int{7, 1}}, []VertexEdges{{0, []Value{1}}, {1, []Value{7, 5, 0}}, {2, []Value{4}}, {4, []Value{2}}, {5, []Value{7, 1}}, {7, []Value{1, 5}}}, []VertexDegree{{0, 1}, {1, 3}, {2, 1}, {4, 1}, {5, 2}, {7, 2}}},
}
