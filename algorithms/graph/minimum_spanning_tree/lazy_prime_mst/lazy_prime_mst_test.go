	...
	var testCases = []testCase{
		{
			...
			mst:    []edge.Edge{edge.NewEdge(0, 7, 0.16), edge.NewEdge(1, 7, 0.19), edge.NewEdge(0, 2, 0.26), edge.NewEdge(2, 3, 0.17), edge.NewEdge(5, 7, 0.28), edge.NewEdge(4, 5, 0.35), edge.NewEdge(6, 2, 0.40)},
			weight: 1.81,
		},
	}
